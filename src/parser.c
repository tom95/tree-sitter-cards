...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_game, 3),
  ...
  [45] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_game, 2),
  [47] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_card_repeat1, 2),
  [49] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 2),
  ...
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_wildcard, 1),
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 5),
  [69] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_arguments, 4),
  ...
  [79] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_duration_specifier, 1),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_duration, 2),
  [83] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [85] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_card, 6),
  [87] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_card, 5),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_card, 3),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_card, 4),
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 2),
  [97] = {.entry = {.count = 1, .reusable = true}}, SHIFT(89),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sequence, 3),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2),
  [103] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_sequence_repeat1, 2), SHIFT_REPEAT(82),
  ...
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_card, 7),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(62),
  [116] = {.entry = {.count = 1, .reusable = true}}, SHIFT(85),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_game_repeat1, 2),
  [120] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_game_repeat1, 2), SHIFT_REPEAT(20),
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope, 3),
  [125] = {.entry = {.count = 1, .reusable = true}}, SHIFT(50),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope, 4),
  [129] = {.entry = {.count = 1, .reusable = true}}, SHIFT(53),
  [131] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scope, 5),
  [133] = {.entry = {.count = 1, .reusable = true}}, SHIFT(58),
  [135] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_pool_repeat1, 2),
  [137] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_pool_repeat1, 2), SHIFT_REPEAT(85),
  [140] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [142] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pool, 4),
  [144] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 5),
  [146] = {.entry = {.count = 1, .reusable = true}}, SHIFT(7),
  [148] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pool, 5),
  [150] = {.entry = {.count = 1, .reusable = true}}, SHIFT(49),
  [152] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [154] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [156] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 4),
  ...
  [164] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_card_repeat1, 2), SHIFT_REPEAT(33),
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 6),
  [169] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_scope_repeat1, 2), SHIFT_REPEAT(61),
  [172] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_scope_repeat1, 2),
  [174] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 6),
  [176] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 5),
  [178] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [180] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [182] = {.entry = {.count = 1, .reusable = true}}, SHIFT(8),
  [184] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_object, 7),
  [186] = {.entry = {.count = 1, .reusable = true}}, SHIFT(51),
  [188] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_game, 1),
  [190] = {.entry = {.count = 1, .reusable = true}}, SHIFT(13),
  [192] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_group, 7),
  [194] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [196] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pool_initializer, 3),
